...
%% Code starts here
function [W, C, funcVal,iter] = Logistic_L21_CMU(X, Y, lam,gam, group_arr,groups)
...
while iter < opts.maxIter
    ...
    while true
        Wzp = SGL_shrink_CMU(Ws - gWs/gamma,group_arr,groups,rho1*gam/gamma,rho1/gamma);

%         Wzp = FGLasso_projection_2stage(Ws - gWs/gamma, rho1/gamma, group_arr);
        Czp = Cs - gCs/gamma;
