function HTCondor_struct2nii(ResultStruct, varargin)
...
%
%   OPTIONS:
%   ResultStruct : The name of the file written by the HTCondor job. Will
%                contain a structure.
